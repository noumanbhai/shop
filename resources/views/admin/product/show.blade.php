				...
				<div class="col-lg-12">
					<div class="p-5">
						...
						<div class="form-row">
							...
							<div class="form-group col-md-6">
								<label for="dprice">Product Discount</label>
								<input type="text" class="form-control @error('discount_price') is-invalid @enderror" value="{{$product->discount_price}}" id="dprice" readonly="">
							</div>
